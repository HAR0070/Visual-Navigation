...
void DrawPoint3(
  ...
  landmark_markers.type = visualization_msgs::msg::Marker::SPHERE_LIST;

  landmark_markers.scale.x = 0.25;
  landmark_markers.scale.y = 0.25;
  landmark_markers.scale.z = 0.25;
